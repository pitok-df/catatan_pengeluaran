...
export default function AllCategories() {
    ...
    if (!categories) {
        return (
            skeleton.map((_, index) => (
                <div key={index + "-category"} className="card bg-gray-200 animate-pulse dark:bg-gray-700 p-2 px-3">
    ...
    return data.length == 0 ? (<h1 className="w-full bg-gray-700 p-3">Empty data.</h1>) :
